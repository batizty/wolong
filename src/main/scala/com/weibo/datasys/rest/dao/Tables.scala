...
trait Tables {
  ...
  class MmDataMining(_tableTag: Tag) extends profile.api.Table[MmDataMiningRow](_tableTag, Some("datasys_monitor"), "mm_data_mining") {
    ...
    def ? = (Rep.Some(id), createdate, totalcount, Rep.Some(`type`), typedesc, totalresultcount).shaped.<>({r=>import r._; _1.map(_=> MmDataMiningRow.tupled((_1.get, _2, _3, _4.get, _5, _6)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmDataVisitorInteraction(_tableTag: Tag) extends profile.api.Table[MmDataVisitorInteractionRow](_tableTag, Some("datasys_monitor"), "mm_data_visitor_interaction") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(action), count, countdate, createdate, Rep.Some(uidTailType), Rep.Some(userType)).shaped.<>({r=>import r._; _1.map(_=> MmDataVisitorInteractionRow.tupled((_1.get, _2.get, _3, _4, _5, _6.get, _7.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmDataVisitorRemain(_tableTag: Tag) extends profile.api.Table[MmDataVisitorRemainRow](_tableTag, Some("datasys_monitor"), "mm_data_visitor_remain") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), countdate, createdate, pvcount, Rep.Some(remainDaysType), Rep.Some(uidTailType), Rep.Some(userType), uvcount).shaped.<>({r=>import r._; _1.map(_=> MmDataVisitorRemainRow.tupled((_1.get, _2, _3, _4, _5.get, _6.get, _7.get, _8)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmDataVisitorUvPv(_tableTag: Tag) extends profile.api.Table[MmDataVisitorUvPvRow](_tableTag, Some("datasys_monitor"), "mm_data_visitor_uv_pv") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), countdate, createdate, pvcount, Rep.Some(uidTailType), Rep.Some(userType), uvcount).shaped.<>({r=>import r._; _1.map(_=> MmDataVisitorUvPvRow.tupled((_1.get, _2, _3, _4, _5.get, _6.get, _7)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmFlume(_tableTag: Tag) extends profile.api.Table[MmFlumeRow](_tableTag, Some("datasys_monitor"), "mm_flume") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), createdate, totalcount, Rep.Some(`type`), typedesc, totalnewcount).shaped.<>({r=>import r._; _1.map(_=> MmFlumeRow.tupled((_1.get, _2, _3, _4.get, _5, _6)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmGroup(_tableTag: Tag) extends profile.api.Table[MmGroupRow](_tableTag, Some("datasys_monitor"), "mm_group") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), cataloguename, createat, creator, groupname).shaped.<>({r=>import r._; _1.map(_=> MmGroupRow.tupled((_1.get, _2, _3, _4, _5)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmKafka(_tableTag: Tag) extends profile.api.Table[MmKafkaRow](_tableTag, Some("datasys_monitor"), "mm_kafka") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), createdate, notconsumecount, totalcount, Rep.Some(`type`), typedesc).shaped.<>({r=>import r._; _1.map(_=> MmKafkaRow.tupled((_1.get, _2, _3, _4, _5.get, _6)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmSession(_tableTag: Tag) extends profile.api.Table[MmSessionRow](_tableTag, Some("datasys_monitor"), "mm_session") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), createat, expireddate, Rep.Some(groupid), Rep.Some(indentfy), token, Rep.Some(userid), username).shaped.<>({r=>import r._; _1.map(_=> MmSessionRow.tupled((_1.get, _2, _3, _4.get, _5.get, _6, _7.get, _8)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmStormTag(_tableTag: Tag) extends profile.api.Table[MmStormTagRow](_tableTag, Some("datasys_monitor"), "mm_storm_tag") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), createdate, totalcount, Rep.Some(`type`), typedesc, totaloriginalcount, totalheadtagcount).shaped.<>({r=>import r._; _1.map(_=> MmStormTagRow.tupled((_1.get, _2, _3, _4.get, _5, _6, _7)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmTrigger(_tableTag: Tag) extends profile.api.Table[MmTriggerRow](_tableTag, Some("datasys_monitor"), "mm_trigger") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), createdate, totalcount, totalresultcount, Rep.Some(`type`), typedesc).shaped.<>({r=>import r._; _1.map(_=> MmTriggerRow.tupled((_1.get, _2, _3, _4, _5.get, _6)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmUser(_tableTag: Tag) extends profile.api.Table[MmUserRow](_tableTag, Some("datasys_monitor"), "mm_user") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), createat, Rep.Some(groupid), Rep.Some(indentfy), lastlogintime, password, state, username).shaped.<>({r=>import r._; _1.map(_=> MmUserRow.tupled((_1.get, _2, _3.get, _4.get, _5, _6, _7, _8)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmWeidisMetrics(_tableTag: Tag) extends profile.api.Table[MmWeidisMetricsRow](_tableTag, Some("datasys_monitor"), "mm_weidis_metrics") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), averageresponsetime, host, queriespersecond, shard, timestamp, vertical).shaped.<>({r=>import r._; _1.map(_=> MmWeidisMetricsRow.tupled((_1.get, _2, _3, _4, _5, _6, _7)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmWgis(_tableTag: Tag) extends profile.api.Table[MmWgisRow](_tableTag, Some("datasys_monitor"), "mm_wgis") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), createdate, host, querycount, shard, timecount, timerange, vertical).shaped.<>({r=>import r._; _1.map(_=> MmWgisRow.tupled((_1.get, _2, _3, _4, _5, _6, _7, _8)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  class MmWgisMetrics(_tableTag: Tag) extends profile.api.Table[MmWgisMetricsRow](_tableTag, Some("datasys_monitor"), "mm_wgis_metrics") {
    ...
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), averageresponsetime, host, queriespersecond, shard, timestamp, vertical).shaped.<>({r=>import r._; _1.map(_=> MmWgisMetricsRow.tupled((_1.get, _2, _3, _4, _5, _6, _7)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
